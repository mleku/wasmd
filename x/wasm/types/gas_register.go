...
const (
	...
	// This is tracked in https://wasmd.mleku.dev/issues/566 and https://wasmd.mleku.dev/issues/631.
	...
	// Benchmarks and numbers were discussed in: https://wasmd.mleku.dev/pull/634#issuecomment-938055852
	...
	// Benchmarks and numbers were discussed in: https://wasmd.mleku.dev/pull/634#issuecomment-938056803
...
// default: 0.15 gas.
// see https://wasmd.mleku.dev/pull/898#discussion_r937727200
...
type WasmGasRegisterConfig struct {
	...
	// See also https://wasmd.mleku.dev/issues/1798 for more thinking around
	// discount cases.
...
// EventCosts costs to persist an event
func (g WasmGasRegister) EventCosts(attrs []wasmvmtypes.EventAttribute,
	events wasmvmtypes.Array[wasmvmtypes.Event]) storetypes.Gas {
